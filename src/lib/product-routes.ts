...
const MODELS: readonly VehicleModelRoute[] = [
  { type: "vehicle_model", brandSlug: "xiaomi", modelSlug: "su7",  modelName: "小米 SU7",  parentPath: "/product/xiaomi",  canonicalPath: "/product/xiaomi/su7",  title: "小米 SU7 专属升级方案",  navLabel: "SU7",  status: "live", priority: "P0", projectCount: 21, sourcePrd: "docs/PRD/product/XIAOMI_SERIES_UPGRADE_PRD_2026-06-24.md" },
