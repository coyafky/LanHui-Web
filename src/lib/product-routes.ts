...
const MODELS: readonly VehicleModelRoute[] = [
  ...
  { type: "vehicle_model", brandSlug: "wenjie", modelSlug: "m6",   modelName: "问界 M6",   parentPath: "/product/wenjie",  canonicalPath: "/product/wenjie/m6",   title: "问界 M6 专属升级方案",   navLabel: "M6",   status: "planned", priority: "P0", projectCount: 30, sourcePrd: "docs/PRD/product/WENJIE_M6_TOPIC_PRD_2026-06-25.md", legacyPaths: ["/product/wenjie-m6"] },
  { type: "vehicle_model", brandSlug: "wenjie", modelSlug: "m7",   modelName: "问界 M7",   parentPath: "/product/wenjie",  canonicalPath: "/product/wenjie/m7",   title: "问界 M7 专属升级方案",   navLabel: "M7",   status: "planned", priority: "P0", projectCount: 32, sourcePrd: "docs/PRD/product/WENJIE_M7_TOPIC_PRD_2026-06-25.md", legacyPaths: ["/product/wenjie-m7"] },
