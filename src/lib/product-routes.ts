...
const BRANDS: readonly VehicleBrandRoute[] = [
  ...
  { type: "vehicle_brand", brandSlug: "li-auto", brandName: "理想",  accentColor: "amber",    status: "planned", priority: "P1", canonicalPath: "/product/li-auto", title: "理想轻改方案", navLabel: "理想", modelSlugs: ["i8", "l9"] },
...
const MODELS: readonly VehicleModelRoute[] = [
  ...
  { type: "vehicle_model", brandSlug: "li-auto", modelSlug: "l9",  modelName: "理想 L9",   parentPath: "/product/li-auto", canonicalPath: "/product/li-auto/l9",   title: "理想 L9 专属升级方案",   navLabel: "L9",   status: "planned", priority: "P1", projectCount: 14, sourcePrd: "docs/PRD/product/LI_AUTO_L9_TOPIC_PRD_2026-06-27.md", legacyPaths: ["/product/li-auto-l9"] },
