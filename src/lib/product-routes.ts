...
const BRANDS: readonly VehicleBrandRoute[] = [
  ...
  { type: "vehicle_brand", brandSlug: "li-auto", brandName: "理想",  accentColor: "amber",    status: "planned", priority: "P1", canonicalPath: "/product/li-auto", title: "理想轻改方案", navLabel: "理想", modelSlugs: ["i8", "l9", "mega"] },
