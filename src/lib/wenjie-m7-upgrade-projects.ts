...
export type WenjieM7ImageStatus = "matched" | "pending-review" | "missing";
...
// ---- §7.1 必改产品（5 项） ----
export const wenjieM7MustHaveProjects = [
  {
    id: "m7-window-film",
    order: 1,
    name: "隔热膜",
...
// ---- §7.2 高级商务升级（15 项） ----
export const wenjieM7BusinessUpgradeProjects = [
  {
...
// ---- §7.3 实用小配件（10 项） ----
export const wenjieM7PracticalAccessoryProjects = [
  {
    id: "m7-door-sill",
    order: 21,
    name: "门槛条",
