...
export const metadata: Metadata = {
  title: "理想 i8 专属升级方案｜蓝辉轻改 LANHUI",
  description: "蓝辉轻改整理理想 i8 常见升级项目，包含必改产品、舒适升级与实用配件。",
};

export default async function LiAutoI8Page() {
  const brand = getBrandRoute("li-auto");
  const model = getModelRoute("li-auto", "i8");
